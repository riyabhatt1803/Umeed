...
import 'package:provider/provider.dart';
      import 'details_clothes_donation1_model.dart';
      export 'details_clothes_donation1_model.dart';
    
class DetailsClothesDonation1Widget extends StatefulWidget {
  const DetailsClothesDonation1Widget({super.key }) ;

  

  @override
  State<DetailsClothesDonation1Widget> createState() => _DetailsClothesDonation1WidgetState();
}

class _DetailsClothesDonation1WidgetState extends State<DetailsClothesDonation1Widget>  {
  late DetailsClothesDonation1Model _model;
...
final scaffoldKey = GlobalKey<ScaffoldState>();
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetailsClothesDonation1Model());
...
,
      ...
      title: Text(
       ...
       FFLocalizations.of(context).getText('1n21xa8s' /* UMEED */,)  ,
...
body: SafeArea(
      ...
      children: [Padding(
       ...
       FFLocalizations.of(context).getText('emmdd812' /* Insights:- */,)  ,
      ...
      child:         Container(
       ...
       40.0
            ...
            children: [ClipRRect(
              ...
              child: Image.network(      
       'https://images.shiksha.com/mediadata/images/1551267234phpadz7I2.jpeg'  ,
...
Padding(
       ...
       FFLocalizations.of(context).getText('zl5fba1j' /* Donation Drive held by NMCCE C... */,)  ,
...
Padding(
       ...
       FFLocalizations.of(context).getText('8nzmhtx0' /* Friday, February 16th  ||  12:... */,)  ,
...
Padding(
       ...
       FFLocalizations.of(context).getText('ucdad3kz' /* N.M. College orchestrated a co... */,)  ,
...
Padding(
      ...
      children: [Padding(
       ...
       FFLocalizations.of(context).getText('pctet6na' /* Event Location */,)  ,
...
Padding(
       ...
       FFLocalizations.of(context).getText('rfb5rybp' /* D.J.Sanghvi College ,6th floor... */,)  ,
...
Padding(
       ...
       FFLocalizations.of(context).getText('w6fz11zr' /* Vile Parle (west) ,400056 */,)  ,
...
Row(
      ...
      child: Padding(
       ...
       FFLocalizations.of(context).getText('p91spn12' /* Donation */,)  ,
...
Expanded(
      ...
      child: Text(
       ...
       FFLocalizations.of(context).getText('cfbgh6a1' /* 249 spots remaining */,)  ,
...
Text(
       ...
       FFLocalizations.of(context).getText('b3ehw85d' /* Friends attending */,)  ,
...
Row(
    ...
    context.pushNamed(
      ...
      child: Text(
       ...
       FFLocalizations.of(context).getText('fe0mlqqg' /* Donate */,)  ,
...
Padding(
    ...
    context.pushNamed(
      ...
      child: Text(
       ...
       FFLocalizations.of(context).getText('egj5734b' /* Receive */,)  ,
