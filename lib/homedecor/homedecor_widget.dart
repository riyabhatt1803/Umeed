...
import 'package:provider/provider.dart';
      import 'homedecor_model.dart';
      export 'homedecor_model.dart';
...
class _HomedecorWidgetState extends State<HomedecorWidget> with TickerProviderStateMixin {
...
body: SafeArea(
      ...
      children: [Padding(
       ...
       FFLocalizations.of(context).getText('6bu3qxzf' /* Home Decorative Items */,)  ,
...
Padding(
       ...
       FFLocalizations.of(context).getText('rv3bs0c1' /* Discover an exquisite array of... */,)  ,
...
Padding(
       ...
       FFLocalizations.of(context).getText('g9zfdeol' /* 4.7 */,)  ,
...
Padding(
       ...
       FFLocalizations.of(context).getText('2rm8ygvj' /* Superhost */,)  ,
      ...
      child:         Container(
          ...
          child: Stack(
            ...
            children: [ClipRRect(
              ...
              child: Image.network(      
       'https://m.media-amazon.com/images/I/81-WYkum6cL._AC_UF894,1000_QL80_.jpg'  ,
...
Image.network(      
       'https://m.media-amazon.com/images/I/61M+JJFL6iL.jpg'  ,
      width: 100.0  ,height: 100.0  ,
      fit: BoxFit.contain,
...
Padding(
      ...
      children: [Text(
       ...
       FFLocalizations.of(context).getText('lbz96qcm' /* 100 */,)  ,
...
Padding(
       ...
       FFLocalizations.of(context).getText('wgc4vjwg' /* Rs */,)  ,
...
FFButtonWidget(
    ...
    context.pushNamed(
      ...
      text: FFLocalizations.of(context).getText('r1y5i61u' /* Buy */,)  ,
