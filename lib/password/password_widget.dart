  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      title: Padding(
       ...
       FFLocalizations.of(context).getText('roejc3p3' /* UMEED */,)  ,
...
Padding(
       ...
       FFLocalizations.of(context).getText('b3ymvgh4' /* Back */,)  ,
...
Padding(
       ...
       FFLocalizations.of(context).getText('i1t3tre7' /* Forgot Password */,)  ,
...
Padding(
       ...
       FFLocalizations.of(context).getText('kydkcpks' /* We will send you an email with... */,)  ,
...
Padding(
    ...
    labelText: FFLocalizations.of(context).getText('gnirv2t5' /* Your email address... */,)  ,
    ...
    hintText: FFLocalizations.of(context).getText('6vzwwfiu' /* Enter your email... */,)  ,
...
Align(
     ...
     await authManager.resetPassword(email: _model.emailAddressTextController.text, context: context,);},
      text: FFLocalizations.of(context).getText('oc36fj7a' /* Send Link */,)  ,
