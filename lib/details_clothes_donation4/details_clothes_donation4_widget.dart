...
import 'package:provider/provider.dart';
      import 'details_clothes_donation4_model.dart';
      export 'details_clothes_donation4_model.dart';
    
class DetailsClothesDonation4Widget extends StatefulWidget {
  const DetailsClothesDonation4Widget({super.key }) ;

  

  @override
  State<DetailsClothesDonation4Widget> createState() => _DetailsClothesDonation4WidgetState();
}

class _DetailsClothesDonation4WidgetState extends State<DetailsClothesDonation4Widget>  {
  late DetailsClothesDonation4Model _model;
...
final scaffoldKey = GlobalKey<ScaffoldState>();
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetailsClothesDonation4Model());
...
,
      ...
      title: Text(
       ...
       FFLocalizations.of(context).getText('mhqcwfl0' /* UMEED */,)  ,
...
body: SafeArea(
      ...
      children: [Padding(
       ...
       FFLocalizations.of(context).getText('ro19ccai' /* Insights:- */,)  ,
      ...
      child:         Container(
       ...
       40.0
            ...
            children: [ClipRRect(
              ...
              child: Image.network(      
       'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTvr8kYfUA_9nUm6iYTpzDrY9bpA-nr4g9z42iOfOzYgB48P4RXH29fmTpqF1Gq9a5s4k8&usqp=CAU'  ,
...
Padding(
       ...
       FFLocalizations.of(context).getText('b7xb683j' /* Donation Drive held by SVKM */,)  ,
...
Padding(
       ...
       FFLocalizations.of(context).getText('dwyt5bjv' /* Friday, February 16th  ||  12:... */,)  ,
...
Padding(
       ...
       FFLocalizations.of(context).getText('y6p32wkc' /* SVKM organized a clothes donat... */,)  ,
...
Padding(
      ...
      children: [Padding(
       ...
       FFLocalizations.of(context).getText('90kbw6ie' /* Event Location */,)  ,
...
Padding(
       ...
       FFLocalizations.of(context).getText('j3pxm5ja' /* ITC Maratha, Mumbai */,)  ,
...
Padding(
       ...
       FFLocalizations.of(context).getText('l4o3v7oq' /*  Sahar, Andheri (East), Mumbai... */,)  ,
...
Row(
      ...
      child: Padding(
       ...
       FFLocalizations.of(context).getText('yqxscj9x' /* Donation */,)  ,
...
Expanded(
      ...
      child: Text(
       ...
       FFLocalizations.of(context).getText('cd772fzd' /* 249 spots remaining */,)  ,
...
Text(
       ...
       FFLocalizations.of(context).getText('tj7y6soo' /* Friends attending */,)  ,
...
Row(
    ...
    context.pushNamed(
      ...
      child: Text(
       ...
       FFLocalizations.of(context).getText('7a7i9zzk' /* Donate */,)  ,
...
Padding(
    ...
    context.pushNamed(
      ...
      child: Text(
       ...
       FFLocalizations.of(context).getText('xs7qdlcn' /* Receive */,)  ,
