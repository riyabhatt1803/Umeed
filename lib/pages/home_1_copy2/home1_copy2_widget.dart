...
import 'package:provider/provider.dart';
      import 'home1_copy2_model.dart';
      export 'home1_copy2_model.dart';
    
class Home1Copy2Widget extends StatefulWidget {
  const Home1Copy2Widget({super.key }) ;

  

  @override
  State<Home1Copy2Widget> createState() => _Home1Copy2WidgetState();
}

class _Home1Copy2WidgetState extends State<Home1Copy2Widget> with TickerProviderStateMixin {
  late Home1Copy2Model _model;
...
final animationsMap = <String, AnimationInfo>{};
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Home1Copy2Model());
  ...
  child: Scaffold(
      ...
      width: double.infinity  ,height: 884.0  ,
      ...
      width: double.infinity  ,height: 572.0  ,
...
() => ClipRRect(
              ...
              borderRadius: BorderRadius.circular( 16.0),
              child: Image.network(      
       'https://images.unsplash.com/photo-1504595403659-9088ce801e29?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyNHx8YW5pbWFsJTIwY2FyZXxlbnwwfHx8fDE3MDc4MzIwMTF8MA&ixlib=rb-4.0.3&q=80&w=1080'  ,
      width: 120.0  ,height: 180.0  ,
      fit: BoxFit.contain,
...
() => ClipRRect(
      ...
      topRight: Radius.circular( 0.0),
              ...
              child: Image.network(      
       'https://images.unsplash.com/photo-1527788263495-3518a5c1c42d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxMXx8ZG9uYXRlfGVufDB8fHx8MTcwNzgzMTk2OXww&ixlib=rb-4.0.3&q=80&w=1080'  ,
      width: 120.0  ,height: 190.0  ,
      fit: BoxFit.cover,
...
() => ClipRRect(
              ...
              borderRadius: BorderRadius.circular( 16.0),
              child: Image.network(      
       'https://images.unsplash.com/photo-1625490237484-a88be8188342?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw5fHxnbyUyMGdyZWVufGVufDB8fHx8MTcwNzgzMjI2MHww&ixlib=rb-4.0.3&q=80&w=1080'  ,
      width: 120.0  ,height: 160.0  ,
      fit: BoxFit.cover,
